...
%
% Changes made by Poetex package:
% 1) Remove \begin{document} and \end{document} commands.
% 2) Remove document class command.
% 3) Remove packages and other document configurations section.
% 4) Remove logo.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
